...
public class Item {
    ...
    public static Item gray() {
        return getSkull("http://textures.minecraft.net/texture/f2f085c6b3cb228e5ba81df562c4786762f3c257127e9725c77b7fd301d37");
    }

    public static Item green() {
        return getSkull("http://textures.minecraft.net/texture/361e5b333c2a3868bb6a58b6674a2639323815738e77e053977419af3f77");
    }

    public static Item getSkull(String url) {
        final Item skull = new Item(Material.SKULL_ITEM, 1, (short) 3);
