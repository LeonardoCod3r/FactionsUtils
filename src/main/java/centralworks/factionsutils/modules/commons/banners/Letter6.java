...
public class Letter6 extends Letter {
    ...
    public ItemStack getBanner(final DyeColor foreGroundColor, final DyeColor backGroundColor, final boolean border) {
        ...
        bannerMeta.addPattern(new Pattern(backGroundColor, PatternType.HALF_HORIZONTAL_MIRROR));
        bannerMeta.addPattern(new Pattern(foreGroundColor, PatternType.STRIPE_RIGHT));
        bannerMeta.addPattern(new Pattern(backGroundColor, PatternType.STRIPE_TOP));
